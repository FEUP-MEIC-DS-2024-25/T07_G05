...
### Python directory
Inside this directory, you have the file script.sh that is the only thing that you need to run to do mutations tests in python. This file starts for running the command:
```bash
